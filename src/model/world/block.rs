...
impl Block {
    ...
    pub fn color(self, face_dir: u8) -> [f32; 4] {
        match self {
            ...
            Block::OakLeaves => [0.2, 0.6, 0.2, 0.95],
            Block::Wood => [0.5, 0.3, 0.1, 1.0],
            Block::Water => [0.0, 0.1, 0.4, 0.9],
            Block::Cloud => [0.95, 0.95, 0.95, 0.95],
            Block::Snow => [0.95, 0.97, 1.0, 1.0],
            Block::Ice => [0.6, 0.8, 0.95, 0.95],
            ...
            Block::SpruceLeaves => [0.15, 0.4, 0.2, 0.95],
            Block::SpruceWood => [0.35, 0.25, 0.15, 1.0],
            Block::BirchLeaves => [0.3, 0.7, 0.3, 0.95],
            Block::BirchWood => [0.85, 0.85, 0.75, 1.0],
            Block::Cactus => [0.25, 0.55, 0.25, 1.0],
            Block::DeadBush => [0.6, 0.5, 0.3, 0.95],
            Block::RedFlower => [0.9, 0.2, 0.2, 0.95],
            Block::YellowFlower => [0.95, 0.9, 0.3, 0.95],
            Block::Moss => [0.35, 0.6, 0.35, 0.95],
            Block::GrassTall => [0.25, 0.7, 0.25, 0.95],
            Block::GrassShort => [0.3, 0.65, 0.3, 0.95],
            Block::SeaGrass => [0.2, 0.5, 0.4, 1.0],
            Block::AcaciaLeaves => [0.5, 0.65, 0.2, 0.95],
            Block::AcaciaWood => [0.6, 0.4, 0.2, 1.0],
            Block::DarkOakLeaves => [0.1, 0.35, 0.15, 0.95],
